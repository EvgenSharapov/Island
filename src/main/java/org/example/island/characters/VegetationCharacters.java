...
public class VegetationCharacters {
    ...
    public static final int HERB_MAX_IN_CAGE=200;
    public static final String BERRIES_NAME="Berries";
    public static final double BERRIES_WEIGHT=5;
    public static final int BERRIES_MAX_IN_CAGE=100;
    public static final String MUSHROOM_NAME="Mushroom";
    public static final double MUSHROOM_WEIGHT=7;
    public static final int MUSHROOM_MAX_IN_CAGE=100;
